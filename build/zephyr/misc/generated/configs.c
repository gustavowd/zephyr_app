...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NUM_IRQS, 102);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SYS_CLOCK_HW_CYCLES_PER_SEC, 170000000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ST_STM32G4_FLASH_CONTROLLER_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ST_STM32G4_PLL_CLOCK_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CMSIS_DSP_FILTERING, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CMSIS_DSP_SUPPORT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USE_STM32_HAL_ADC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USE_STM32_HAL_ADC_EX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USE_STM32_HAL_CORTEX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USE_STM32_HAL_DAC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USE_STM32_HAL_DAC_EX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USE_STM32_HAL_DMA, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USE_STM32_HAL_DMA_EX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NUCLEO_G474RE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NUCLEO_G474RE_STM32G474XX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_QUALIFIERS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_FAMILY_STM32, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_SERIES_STM32G4X, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_STM32G474XX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_THREAD_RUNTIME_STATS_USE_TIMING_FUNCTIONS, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CLOCK_STM32_HSE_CLOCK, 24000000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_STACK_SIZE, 8192);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TIMING_FUNCTIONS_NEED_AT_BOOT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_WITH_STM32_HAL, 1);
