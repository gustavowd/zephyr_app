...
ztest :
{
 ...
 zbus_observer_area : SUBALIGN(4) { _zbus_observer_list_start = .; KEEP(*(SORT_BY_NAME(._zbus_observer.static.*))); _zbus_observer_list_end = .; } > FLASH
 ...
 *(".kernel.*")
 ...
 zbus_channel_observation_mask_area : ALIGN_WITH_INPUT { _zbus_channel_observation_mask_list_start = .; KEEP(*(SORT_BY_NAME(._zbus_channel_observation_mask.static.*))); _zbus_channel_observation_mask_list_end = .; } > RAM AT > FLASH
    __data_region_end = .;
